...
SELECT 
	...
	log(cast(pf.total_booked_cancelation_prediction AS double)) AS total_booked_cancelation_prediction_log,
	log(pf.COALESCE(ctr.total_cancelations_rs,0)) AS total_cancelations_rs_log,
	log(pf.COALESCE(cgr.total_bookings_rs,0)) AS total_bookings_rs_log,
...
SELECT * FROM hive.bi_vlt.vlt_demand_prediction_past_forecasts